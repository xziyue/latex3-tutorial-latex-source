...
\section{Macro Expansion Control (MPC) in \LTT{}}\label{sec:macro-expansion-control}
In \cref{sec:intro-macro-expansion-control}, we briefly introduce the concept of Macro Expansion Control (MPC).
Here, we elaborate on how it is done in \LTT{}.


\begin{latexsample}[examplelabel={ex:mpc-func},exampletitle={Example Function Used in Section \ref{sec:macro-expansion-control}}]
  \ExplSyntaxOn
  % the example function used in this section
  \cs_new:Npn \my_mpc_func:nn #1#2
  {
