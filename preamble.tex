...
\tcbuselibrary{listings, skins, breakable, xparse, hooks}
...
% % listing only anonymous example
...
\usepackage{silence}
\WarningFilter{latex}{Writing or overwriting}

% load pygments styles
\input{style/default.tex}

\lstdefinestyle{tex3inline}{
    
}

% \newcommand{\inlinestylea}[1]{{\ttfamily #1}}
% \newcommand{\inlinestyleb}[1]{{\ttfamily #1}}