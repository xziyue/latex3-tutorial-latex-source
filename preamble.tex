...
\bool_new:N \CurrentExampleNoTitle
...
\tl_new:N \l_latex_example_tmpa_tl
\tl_new:N \l_latex_example_tmpb_tl
...
\cs_set:Npn \doc_include_latex_example:n #1 {
    ...
    \SetBoolFalse\CurrentExampleNoTitle
    \SetLstRefLabel{}

    \clist_map_inline:nn {#1}
    {
        \str_set:Nx \l_latex_example_tmpa_tl { \tl_trim_spaces:n {##1} }
        \exp_args:NV \str_if_eq:nnT \l_latex_example_tmpa_tl {notitle} {
            \SetBoolTrue\CurrentExampleNoTitle
            \clist_map_break:
        }
    }
    ...
    \bool_if:NTF \CurrentExampleNoTitle
    {
