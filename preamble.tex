...
\seq_new:N \l_lst_title_segments_seq
...
\cs_set:Npn \@@DoLaTeXExample #1 {
    ...
    % generate title
    \seq_clear:N \l_lst_title_segments_seq
    \tl_if_empty:NTF \CurrentExampleTitle
    {
        \seq_put_right:Nx \l_lst_title_segments_seq {title={Example~\thecodeexample}}
    }
    {
        \seq_put_right:Nx \l_lst_title_segments_seq {title={Example~\thecodeexample:~\exp_not:V \CurrentExampleTitle}}
    }
    ...
    \exp_args:Nx \tcbinputlisting { 
        ...
        \seq_use:Nn \l_lst_title_segments_seq {,}
        \exp_not:V #1
    }
